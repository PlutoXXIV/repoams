...
class Init_FollowPath_Goal_progress_checker_id
{
public:
  explicit Init_FollowPath_Goal_progress_checker_id(::nav2_msgs::action::FollowPath_Goal & msg)
  : msg_(msg)
  {}
  ::nav2_msgs::action::FollowPath_Goal progress_checker_id(::nav2_msgs::action::FollowPath_Goal::_progress_checker_id_type arg)
  {
    msg_.progress_checker_id = std::move(arg);
...
public:
  ...
  : msg_(msg)
  {}
  Init_FollowPath_Goal_progress_checker_id goal_checker_id(::nav2_msgs::action::FollowPath_Goal::_goal_checker_id_type arg)
  {
    msg_.goal_checker_id = std::move(arg);
    return Init_FollowPath_Goal_progress_checker_id(msg_);
  }
...
class Init_FollowPath_Result_error_msg
{
public:
  explicit Init_FollowPath_Result_error_msg(::nav2_msgs::action::FollowPath_Result & msg)
  : msg_(msg)
  {}
  ::nav2_msgs::action::FollowPath_Result error_msg(::nav2_msgs::action::FollowPath_Result::_error_msg_type arg)
  {
...
class Init_FollowPath_Result_error_code
{
public:
  explicit Init_FollowPath_Result_error_code(::nav2_msgs::action::FollowPath_Result & msg)
  : msg_(msg)
  {}
  Init_FollowPath_Result_error_msg error_code(::nav2_msgs::action::FollowPath_Result::_error_code_type arg)
  {
    msg_.error_code = std::move(arg);
    return Init_FollowPath_Result_error_msg(msg_);
  }
...
public:
  ...
  : msg_(::rosidl_runtime_cpp::MessageInitialization::SKIP)
  {}
  Init_FollowPath_Result_error_code result(::nav2_msgs::action::FollowPath_Result::_result_type arg)
  {
    msg_.result = std::move(arg);
    return Init_FollowPath_Result_error_code(msg_);
  }
...
class Init_FollowPath_Feedback_tracking_feedback
{
public:
  Init_FollowPath_Feedback_tracking_feedback()
  : msg_(::rosidl_runtime_cpp::MessageInitialization::SKIP)
  {}
  ::nav2_msgs::action::FollowPath_Feedback tracking_feedback(::nav2_msgs::action::FollowPath_Feedback::_tracking_feedback_type arg)
  {
    msg_.tracking_feedback = std::move(arg);
    return std::move(msg_);
  }
...
{
  return nav2_msgs::action::builder::Init_FollowPath_Feedback_tracking_feedback();
}
...
{
public:
  explicit Init_FollowPath_SendGoal_Event_response(::nav2_msgs::action::FollowPath_SendGoal_Event & msg)
  : msg_(msg)
  {}
  ::nav2_msgs::action::FollowPath_SendGoal_Event response(::nav2_msgs::action::FollowPath_SendGoal_Event::_response_type arg)
  {
...
private:
  ::nav2_msgs::action::FollowPath_SendGoal_Event msg_;
};

class Init_FollowPath_SendGoal_Event_request
{
public:
  explicit Init_FollowPath_SendGoal_Event_request(::nav2_msgs::action::FollowPath_SendGoal_Event & msg)
  : msg_(msg)
  {}
  Init_FollowPath_SendGoal_Event_response request(::nav2_msgs::action::FollowPath_SendGoal_Event::_request_type arg)
  {
...
public:
  ...
  : msg_(::rosidl_runtime_cpp::MessageInitialization::SKIP)
  {}
  Init_FollowPath_SendGoal_Event_request info(::nav2_msgs::action::FollowPath_SendGoal_Event::_info_type arg)
  {
...
template<>
inline
auto build<::nav2_msgs::action::FollowPath_SendGoal_Event>()
{
  return nav2_msgs::action::builder::Init_FollowPath_SendGoal_Event_info();
}
...
{
public:
  explicit Init_FollowPath_GetResult_Event_response(::nav2_msgs::action::FollowPath_GetResult_Event & msg)
  : msg_(msg)
  {}
  ::nav2_msgs::action::FollowPath_GetResult_Event response(::nav2_msgs::action::FollowPath_GetResult_Event::_response_type arg)
  {
    msg_.response = std::move(arg);
    return std::move(msg_);
  }
...
private:
  ::nav2_msgs::action::FollowPath_GetResult_Event msg_;
};

class Init_FollowPath_GetResult_Event_request
{
public:
  explicit Init_FollowPath_GetResult_Event_request(::nav2_msgs::action::FollowPath_GetResult_Event & msg)
  : msg_(msg)
  {}
  Init_FollowPath_GetResult_Event_response request(::nav2_msgs::action::FollowPath_GetResult_Event::_request_type arg)
  {
    msg_.request = std::move(arg);
...
public:
  ...
  : msg_(::rosidl_runtime_cpp::MessageInitialization::SKIP)
  {}
  Init_FollowPath_GetResult_Event_request info(::nav2_msgs::action::FollowPath_GetResult_Event::_info_type arg)
  {
    msg_.info = std::move(arg);
...
template<>
inline
auto build<::nav2_msgs::action::FollowPath_GetResult_Event>()
{
  return nav2_msgs::action::builder::Init_FollowPath_GetResult_Event_info();
}
