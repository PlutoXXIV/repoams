...
// IWYU pragma: private, include "nav2_msgs/action/follow_path.hpp"
...
struct FollowPath_Goal_
{
  ...
  using _progress_checker_id_type =
    std::basic_string<char, std::char_traits<char>, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<char>>;
  _progress_checker_id_type progress_checker_id;
  ...
  Type & set__progress_checker_id(
    const std::basic_string<char, std::char_traits<char>, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<char>> & _arg)
  {
    this->progress_checker_id = _arg;
    return *this;
  }
  ...
  bool operator==(const FollowPath_Goal_ & other) const
  {
    ...
    if (this->progress_checker_id != other.progress_checker_id) {
      return false;
    }
    return true;
  }
...
struct FollowPath_Result_
{
  ...
  static constexpr uint16_t UNKNOWN =
    100u;
  static constexpr uint16_t INVALID_CONTROLLER =
    101u;
  static constexpr uint16_t TF_ERROR =
    102u;
  static constexpr uint16_t INVALID_PATH =
    103u;
  static constexpr uint16_t PATIENCE_EXCEEDED =
    104u;
  static constexpr uint16_t FAILED_TO_MAKE_PROGRESS =
    105u;
  static constexpr uint16_t NO_VALID_CONTROL =
    106u;
...
constexpr uint16_t FollowPath_Result_<ContainerAllocator>::NONE;
#endif  // __cplusplus < 201703L
#if __cplusplus < 201703L
// static constexpr member variable definitions are only needed in C++14 and below, deprecated in C++17
template<typename ContainerAllocator>
constexpr uint16_t FollowPath_Result_<ContainerAllocator>::UNKNOWN;
#endif  // __cplusplus < 201703L
#if __cplusplus < 201703L
// static constexpr member variable definitions are only needed in C++14 and below, deprecated in C++17
template<typename ContainerAllocator>
constexpr uint16_t FollowPath_Result_<ContainerAllocator>::INVALID_CONTROLLER;
#endif  // __cplusplus < 201703L
#if __cplusplus < 201703L
// static constexpr member variable definitions are only needed in C++14 and below, deprecated in C++17
template<typename ContainerAllocator>
constexpr uint16_t FollowPath_Result_<ContainerAllocator>::TF_ERROR;
#endif  // __cplusplus < 201703L
#if __cplusplus < 201703L
// static constexpr member variable definitions are only needed in C++14 and below, deprecated in C++17
template<typename ContainerAllocator>
constexpr uint16_t FollowPath_Result_<ContainerAllocator>::INVALID_PATH;
#endif  // __cplusplus < 201703L
#if __cplusplus < 201703L
// static constexpr member variable definitions are only needed in C++14 and below, deprecated in C++17
template<typename ContainerAllocator>
constexpr uint16_t FollowPath_Result_<ContainerAllocator>::PATIENCE_EXCEEDED;
#endif  // __cplusplus < 201703L
#if __cplusplus < 201703L
// static constexpr member variable definitions are only needed in C++14 and below, deprecated in C++17
template<typename ContainerAllocator>
constexpr uint16_t FollowPath_Result_<ContainerAllocator>::FAILED_TO_MAKE_PROGRESS;
#endif  // __cplusplus < 201703L
#if __cplusplus < 201703L
// static constexpr member variable definitions are only needed in C++14 and below, deprecated in C++17
template<typename ContainerAllocator>
constexpr uint16_t FollowPath_Result_<ContainerAllocator>::NO_VALID_CONTROL;
#endif  // __cplusplus < 201703L
#if __cplusplus < 201703L
// static constexpr member variable definitions are only needed in C++14 and below, deprecated in C++17
template<typename ContainerAllocator>
constexpr uint16_t FollowPath_Result_<ContainerAllocator>::CONTROLLER_TIMED_OUT;
#endif  // __cplusplus < 201703L
...
struct FollowPath_Feedback_
{
  ...
  : tracking_feedback(_alloc, _init)
  {
    (void)_init;
  }

  // field types and members
  using _tracking_feedback_type =
    nav2_msgs::msg::TrackingFeedback_<ContainerAllocator>;
  _tracking_feedback_type tracking_feedback;

  // setters for named parameter idiom
  Type & set__tracking_feedback(
    const nav2_msgs::msg::TrackingFeedback_<ContainerAllocator> & _arg)
  {
    this->tracking_feedback = _arg;
    return *this;
  }
  ...
  {
    if (this->tracking_feedback != other.tracking_feedback) {
      return false;
    }
    return true;
  }
...
#ifndef _WIN32
# define DEPRECATED__nav2_msgs__action__FollowPath_SendGoal_Event __attribute__((deprecated))
#else
# define DEPRECATED__nav2_msgs__action__FollowPath_SendGoal_Event __declspec(deprecated)
#endif
...
struct FollowPath_SendGoal_Event_
{
  ...
  _info_type info;
  using _request_type =
    rosidl_runtime_cpp::BoundedVector<nav2_msgs::action::FollowPath_SendGoal_Request_<ContainerAllocator>, 1, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<nav2_msgs::action::FollowPath_SendGoal_Request_<ContainerAllocator>>>;
  _request_type request;
  using _response_type =
    rosidl_runtime_cpp::BoundedVector<nav2_msgs::action::FollowPath_SendGoal_Response_<ContainerAllocator>, 1, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<nav2_msgs::action::FollowPath_SendGoal_Response_<ContainerAllocator>>>;
  ...
  Type & set__request(
    const rosidl_runtime_cpp::BoundedVector<nav2_msgs::action::FollowPath_SendGoal_Request_<ContainerAllocator>, 1, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<nav2_msgs::action::FollowPath_SendGoal_Request_<ContainerAllocator>>> & _arg)
  {
    this->request = _arg;
    return *this;
  }
  Type & set__response(
    const rosidl_runtime_cpp::BoundedVector<nav2_msgs::action::FollowPath_SendGoal_Response_<ContainerAllocator>, 1, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<nav2_msgs::action::FollowPath_SendGoal_Response_<ContainerAllocator>>> & _arg)
  {
    this->response = _arg;
    return *this;
  }
  ...
  // pointer types
  using RawPtr =
    nav2_msgs::action::FollowPath_SendGoal_Event_<ContainerAllocator> *;
  using ConstRawPtr =
    const nav2_msgs::action::FollowPath_SendGoal_Event_<ContainerAllocator> *;
  using SharedPtr =
    std::shared_ptr<nav2_msgs::action::FollowPath_SendGoal_Event_<ContainerAllocator>>;
  using ConstSharedPtr =
    std::shared_ptr<nav2_msgs::action::FollowPath_SendGoal_Event_<ContainerAllocator> const>;

  template<typename Deleter = std::default_delete<
      nav2_msgs::action::FollowPath_SendGoal_Event_<ContainerAllocator>>>
  using UniquePtrWithDeleter =
    std::unique_ptr<nav2_msgs::action::FollowPath_SendGoal_Event_<ContainerAllocator>, Deleter>;
  ...
  template<typename Deleter = std::default_delete<
      nav2_msgs::action::FollowPath_SendGoal_Event_<ContainerAllocator>>>
  using ConstUniquePtrWithDeleter =
    std::unique_ptr<nav2_msgs::action::FollowPath_SendGoal_Event_<ContainerAllocator> const, Deleter>;
  using ConstUniquePtr = ConstUniquePtrWithDeleter<>;

  using WeakPtr =
    std::weak_ptr<nav2_msgs::action::FollowPath_SendGoal_Event_<ContainerAllocator>>;
  using ConstWeakPtr =
    std::weak_ptr<nav2_msgs::action::FollowPath_SendGoal_Event_<ContainerAllocator> const>;

  // pointer types similar to ROS 1, use SharedPtr / ConstSharedPtr instead
  // NOTE: Can't use 'using' here because GNU C++ can't parse attributes properly
  typedef DEPRECATED__nav2_msgs__action__FollowPath_SendGoal_Event
    std::shared_ptr<nav2_msgs::action::FollowPath_SendGoal_Event_<ContainerAllocator>>
    Ptr;
  typedef DEPRECATED__nav2_msgs__action__FollowPath_SendGoal_Event
    std::shared_ptr<nav2_msgs::action::FollowPath_SendGoal_Event_<ContainerAllocator> const>
...
using FollowPath_SendGoal_Event =
  nav2_msgs::action::FollowPath_SendGoal_Event_<std::allocator<void>>;
...
struct FollowPath_SendGoal
{
  ...
  using Event = nav2_msgs::action::FollowPath_SendGoal_Event;
};
...
#ifndef _WIN32
# define DEPRECATED__nav2_msgs__action__FollowPath_GetResult_Event __attribute__((deprecated))
#else
# define DEPRECATED__nav2_msgs__action__FollowPath_GetResult_Event __declspec(deprecated)
#endif
...
struct FollowPath_GetResult_Event_
{
  ...
  _info_type info;
  using _request_type =
    rosidl_runtime_cpp::BoundedVector<nav2_msgs::action::FollowPath_GetResult_Request_<ContainerAllocator>, 1, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<nav2_msgs::action::FollowPath_GetResult_Request_<ContainerAllocator>>>;
  _request_type request;
  using _response_type =
    rosidl_runtime_cpp::BoundedVector<nav2_msgs::action::FollowPath_GetResult_Response_<ContainerAllocator>, 1, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<nav2_msgs::action::FollowPath_GetResult_Response_<ContainerAllocator>>>;
  _response_type response;
  ...
  Type & set__request(
    const rosidl_runtime_cpp::BoundedVector<nav2_msgs::action::FollowPath_GetResult_Request_<ContainerAllocator>, 1, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<nav2_msgs::action::FollowPath_GetResult_Request_<ContainerAllocator>>> & _arg)
  {
    this->request = _arg;
    return *this;
  }
  Type & set__response(
    const rosidl_runtime_cpp::BoundedVector<nav2_msgs::action::FollowPath_GetResult_Response_<ContainerAllocator>, 1, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<nav2_msgs::action::FollowPath_GetResult_Response_<ContainerAllocator>>> & _arg)
  {
    this->response = _arg;
    return *this;
  }
  ...
  // pointer types
  using RawPtr =
    nav2_msgs::action::FollowPath_GetResult_Event_<ContainerAllocator> *;
  using ConstRawPtr =
    const nav2_msgs::action::FollowPath_GetResult_Event_<ContainerAllocator> *;
  using SharedPtr =
    std::shared_ptr<nav2_msgs::action::FollowPath_GetResult_Event_<ContainerAllocator>>;
  using ConstSharedPtr =
    std::shared_ptr<nav2_msgs::action::FollowPath_GetResult_Event_<ContainerAllocator> const>;

  template<typename Deleter = std::default_delete<
      nav2_msgs::action::FollowPath_GetResult_Event_<ContainerAllocator>>>
  using UniquePtrWithDeleter =
    std::unique_ptr<nav2_msgs::action::FollowPath_GetResult_Event_<ContainerAllocator>, Deleter>;
  ...
  template<typename Deleter = std::default_delete<
      nav2_msgs::action::FollowPath_GetResult_Event_<ContainerAllocator>>>
  using ConstUniquePtrWithDeleter =
    std::unique_ptr<nav2_msgs::action::FollowPath_GetResult_Event_<ContainerAllocator> const, Deleter>;
  using ConstUniquePtr = ConstUniquePtrWithDeleter<>;

  using WeakPtr =
    std::weak_ptr<nav2_msgs::action::FollowPath_GetResult_Event_<ContainerAllocator>>;
  using ConstWeakPtr =
    std::weak_ptr<nav2_msgs::action::FollowPath_GetResult_Event_<ContainerAllocator> const>;

  // pointer types similar to ROS 1, use SharedPtr / ConstSharedPtr instead
  // NOTE: Can't use 'using' here because GNU C++ can't parse attributes properly
  typedef DEPRECATED__nav2_msgs__action__FollowPath_GetResult_Event
    std::shared_ptr<nav2_msgs::action::FollowPath_GetResult_Event_<ContainerAllocator>>
    Ptr;
  typedef DEPRECATED__nav2_msgs__action__FollowPath_GetResult_Event
    std::shared_ptr<nav2_msgs::action::FollowPath_GetResult_Event_<ContainerAllocator> const>
...
using FollowPath_GetResult_Event =
  nav2_msgs::action::FollowPath_GetResult_Event_<std::allocator<void>>;
...
struct FollowPath_GetResult
{
  ...
  using Event = nav2_msgs::action::FollowPath_GetResult_Event;
};
