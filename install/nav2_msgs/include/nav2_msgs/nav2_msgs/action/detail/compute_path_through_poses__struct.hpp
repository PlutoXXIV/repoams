...
struct ComputePathThroughPoses_Goal_
{
  ...
  Type & set__goals(
    const nav_msgs::msg::Goals_<ContainerAllocator> & _arg)
  {
    this->goals = _arg;
    return *this;
  }
...
struct ComputePathThroughPoses_Result_
{
    ...
    planning_time(_init)
  {
    ...
    {
      this->last_reached_index = -1;
    } else if (rosidl_runtime_cpp::MessageInitialization::ZERO == _init) {
      this->last_reached_index = 0;
      this->error_code = 0;
      this->error_msg = "";
    }
    if (rosidl_runtime_cpp::MessageInitialization::ALL == _init ||
  ...
  _path_type path;
  using _last_reached_index_type =
    int16_t;
  _last_reached_index_type last_reached_index;
  ...
  Type & set__last_reached_index(
    const int16_t & _arg)
  {
    this->last_reached_index = _arg;
    return *this;
  }
  ...
  // constant declarations
  static constexpr int16_t ALL_GOALS =
    -1;
  ...
  static constexpr uint16_t NO_VALID_PATH =
    308u;
  static constexpr uint16_t NO_VIAPOINTS_GIVEN =
    309u;
  ...
  bool operator==(const ComputePathThroughPoses_Result_ & other) const
  {
    ...
    if (this->last_reached_index != other.last_reached_index) {
      return false;
    }
...
constexpr int16_t ComputePathThroughPoses_Result_<ContainerAllocator>::ALL_GOALS;
#endif  // __cplusplus < 201703L
#if __cplusplus < 201703L
// static constexpr member variable definitions are only needed in C++14 and below, deprecated in C++17
template<typename ContainerAllocator>
constexpr uint16_t ComputePathThroughPoses_Result_<ContainerAllocator>::NONE;
#endif  // __cplusplus < 201703L
#if __cplusplus < 201703L
// static constexpr member variable definitions are only needed in C++14 and below, deprecated in C++17
template<typename ContainerAllocator>
constexpr uint16_t ComputePathThroughPoses_Result_<ContainerAllocator>::UNKNOWN;
#endif  // __cplusplus < 201703L
#if __cplusplus < 201703L
// static constexpr member variable definitions are only needed in C++14 and below, deprecated in C++17
template<typename ContainerAllocator>
constexpr uint16_t ComputePathThroughPoses_Result_<ContainerAllocator>::INVALID_PLANNER;
#endif  // __cplusplus < 201703L
#if __cplusplus < 201703L
// static constexpr member variable definitions are only needed in C++14 and below, deprecated in C++17
template<typename ContainerAllocator>
constexpr uint16_t ComputePathThroughPoses_Result_<ContainerAllocator>::TF_ERROR;
#endif  // __cplusplus < 201703L
#if __cplusplus < 201703L
// static constexpr member variable definitions are only needed in C++14 and below, deprecated in C++17
template<typename ContainerAllocator>
constexpr uint16_t ComputePathThroughPoses_Result_<ContainerAllocator>::START_OUTSIDE_MAP;
#endif  // __cplusplus < 201703L
#if __cplusplus < 201703L
// static constexpr member variable definitions are only needed in C++14 and below, deprecated in C++17
template<typename ContainerAllocator>
constexpr uint16_t ComputePathThroughPoses_Result_<ContainerAllocator>::GOAL_OUTSIDE_MAP;
#endif  // __cplusplus < 201703L
#if __cplusplus < 201703L
// static constexpr member variable definitions are only needed in C++14 and below, deprecated in C++17
template<typename ContainerAllocator>
constexpr uint16_t ComputePathThroughPoses_Result_<ContainerAllocator>::START_OCCUPIED;
#endif  // __cplusplus < 201703L
#if __cplusplus < 201703L
// static constexpr member variable definitions are only needed in C++14 and below, deprecated in C++17
template<typename ContainerAllocator>
constexpr uint16_t ComputePathThroughPoses_Result_<ContainerAllocator>::GOAL_OCCUPIED;
#endif  // __cplusplus < 201703L
#if __cplusplus < 201703L
// static constexpr member variable definitions are only needed in C++14 and below, deprecated in C++17
template<typename ContainerAllocator>
constexpr uint16_t ComputePathThroughPoses_Result_<ContainerAllocator>::TIMEOUT;
#endif  // __cplusplus < 201703L
#if __cplusplus < 201703L
// static constexpr member variable definitions are only needed in C++14 and below, deprecated in C++17
template<typename ContainerAllocator>
constexpr uint16_t ComputePathThroughPoses_Result_<ContainerAllocator>::NO_VALID_PATH;
#endif  // __cplusplus < 201703L
#if __cplusplus < 201703L
// static constexpr member variable definitions are only needed in C++14 and below, deprecated in C++17
template<typename ContainerAllocator>
constexpr uint16_t ComputePathThroughPoses_Result_<ContainerAllocator>::NO_VIAPOINTS_GIVEN;
#endif  // __cplusplus < 201703L
...
#ifndef _WIN32
# define DEPRECATED__nav2_msgs__action__ComputePathThroughPoses_SendGoal_Event __attribute__((deprecated))
#else
# define DEPRECATED__nav2_msgs__action__ComputePathThroughPoses_SendGoal_Event __declspec(deprecated)
#endif
...
// message struct
template<class ContainerAllocator>
struct ComputePathThroughPoses_SendGoal_Event_
{
  using Type = ComputePathThroughPoses_SendGoal_Event_<ContainerAllocator>;

  explicit ComputePathThroughPoses_SendGoal_Event_(rosidl_runtime_cpp::MessageInitialization _init = rosidl_runtime_cpp::MessageInitialization::ALL)
  : info(_init)
  {
    (void)_init;
  }

  explicit ComputePathThroughPoses_SendGoal_Event_(const ContainerAllocator & _alloc, rosidl_runtime_cpp::MessageInitialization _init = rosidl_runtime_cpp::MessageInitialization::ALL)
  : info(_alloc, _init)
  {
    (void)_init;
  }
  ...
  _info_type info;
  using _request_type =
    rosidl_runtime_cpp::BoundedVector<nav2_msgs::action::ComputePathThroughPoses_SendGoal_Request_<ContainerAllocator>, 1, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<nav2_msgs::action::ComputePathThroughPoses_SendGoal_Request_<ContainerAllocator>>>;
  _request_type request;
  using _response_type =
    rosidl_runtime_cpp::BoundedVector<nav2_msgs::action::ComputePathThroughPoses_SendGoal_Response_<ContainerAllocator>, 1, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<nav2_msgs::action::ComputePathThroughPoses_SendGoal_Response_<ContainerAllocator>>>;
  ...
  Type & set__request(
    const rosidl_runtime_cpp::BoundedVector<nav2_msgs::action::ComputePathThroughPoses_SendGoal_Request_<ContainerAllocator>, 1, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<nav2_msgs::action::ComputePathThroughPoses_SendGoal_Request_<ContainerAllocator>>> & _arg)
  {
    this->request = _arg;
    return *this;
  }
  Type & set__response(
    const rosidl_runtime_cpp::BoundedVector<nav2_msgs::action::ComputePathThroughPoses_SendGoal_Response_<ContainerAllocator>, 1, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<nav2_msgs::action::ComputePathThroughPoses_SendGoal_Response_<ContainerAllocator>>> & _arg)
  {
    this->response = _arg;
    return *this;
  }
  ...
  // pointer types
  using RawPtr =
    nav2_msgs::action::ComputePathThroughPoses_SendGoal_Event_<ContainerAllocator> *;
  using ConstRawPtr =
    const nav2_msgs::action::ComputePathThroughPoses_SendGoal_Event_<ContainerAllocator> *;
  using SharedPtr =
    std::shared_ptr<nav2_msgs::action::ComputePathThroughPoses_SendGoal_Event_<ContainerAllocator>>;
  using ConstSharedPtr =
    std::shared_ptr<nav2_msgs::action::ComputePathThroughPoses_SendGoal_Event_<ContainerAllocator> const>;

  template<typename Deleter = std::default_delete<
      nav2_msgs::action::ComputePathThroughPoses_SendGoal_Event_<ContainerAllocator>>>
  using UniquePtrWithDeleter =
    std::unique_ptr<nav2_msgs::action::ComputePathThroughPoses_SendGoal_Event_<ContainerAllocator>, Deleter>;
  ...
  template<typename Deleter = std::default_delete<
      nav2_msgs::action::ComputePathThroughPoses_SendGoal_Event_<ContainerAllocator>>>
  using ConstUniquePtrWithDeleter =
    std::unique_ptr<nav2_msgs::action::ComputePathThroughPoses_SendGoal_Event_<ContainerAllocator> const, Deleter>;
  using ConstUniquePtr = ConstUniquePtrWithDeleter<>;

  using WeakPtr =
    std::weak_ptr<nav2_msgs::action::ComputePathThroughPoses_SendGoal_Event_<ContainerAllocator>>;
  using ConstWeakPtr =
    std::weak_ptr<nav2_msgs::action::ComputePathThroughPoses_SendGoal_Event_<ContainerAllocator> const>;

  // pointer types similar to ROS 1, use SharedPtr / ConstSharedPtr instead
  // NOTE: Can't use 'using' here because GNU C++ can't parse attributes properly
  typedef DEPRECATED__nav2_msgs__action__ComputePathThroughPoses_SendGoal_Event
    std::shared_ptr<nav2_msgs::action::ComputePathThroughPoses_SendGoal_Event_<ContainerAllocator>>
    Ptr;
  typedef DEPRECATED__nav2_msgs__action__ComputePathThroughPoses_SendGoal_Event
    std::shared_ptr<nav2_msgs::action::ComputePathThroughPoses_SendGoal_Event_<ContainerAllocator> const>
  ...
  // comparison operators
  bool operator==(const ComputePathThroughPoses_SendGoal_Event_ & other) const
  {
...
// alias to use template instance with default allocator
using ComputePathThroughPoses_SendGoal_Event =
  nav2_msgs::action::ComputePathThroughPoses_SendGoal_Event_<std::allocator<void>>;
...
struct ComputePathThroughPoses_SendGoal
{
  ...
  using Event = nav2_msgs::action::ComputePathThroughPoses_SendGoal_Event;
};
...
#ifndef _WIN32
# define DEPRECATED__nav2_msgs__action__ComputePathThroughPoses_GetResult_Event __attribute__((deprecated))
#else
# define DEPRECATED__nav2_msgs__action__ComputePathThroughPoses_GetResult_Event __declspec(deprecated)
#endif
...
// message struct
template<class ContainerAllocator>
struct ComputePathThroughPoses_GetResult_Event_
{
  using Type = ComputePathThroughPoses_GetResult_Event_<ContainerAllocator>;

  explicit ComputePathThroughPoses_GetResult_Event_(rosidl_runtime_cpp::MessageInitialization _init = rosidl_runtime_cpp::MessageInitialization::ALL)
  : info(_init)
  {
    (void)_init;
  }

  explicit ComputePathThroughPoses_GetResult_Event_(const ContainerAllocator & _alloc, rosidl_runtime_cpp::MessageInitialization _init = rosidl_runtime_cpp::MessageInitialization::ALL)
  : info(_alloc, _init)
  {
    (void)_init;
  }
  ...
  _info_type info;
  using _request_type =
    rosidl_runtime_cpp::BoundedVector<nav2_msgs::action::ComputePathThroughPoses_GetResult_Request_<ContainerAllocator>, 1, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<nav2_msgs::action::ComputePathThroughPoses_GetResult_Request_<ContainerAllocator>>>;
  _request_type request;
  using _response_type =
    rosidl_runtime_cpp::BoundedVector<nav2_msgs::action::ComputePathThroughPoses_GetResult_Response_<ContainerAllocator>, 1, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<nav2_msgs::action::ComputePathThroughPoses_GetResult_Response_<ContainerAllocator>>>;
  _response_type response;
  ...
  Type & set__request(
    const rosidl_runtime_cpp::BoundedVector<nav2_msgs::action::ComputePathThroughPoses_GetResult_Request_<ContainerAllocator>, 1, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<nav2_msgs::action::ComputePathThroughPoses_GetResult_Request_<ContainerAllocator>>> & _arg)
  {
    this->request = _arg;
    return *this;
  }
  Type & set__response(
    const rosidl_runtime_cpp::BoundedVector<nav2_msgs::action::ComputePathThroughPoses_GetResult_Response_<ContainerAllocator>, 1, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<nav2_msgs::action::ComputePathThroughPoses_GetResult_Response_<ContainerAllocator>>> & _arg)
  {
    this->response = _arg;
    return *this;
  }
  ...
  // pointer types
  using RawPtr =
    nav2_msgs::action::ComputePathThroughPoses_GetResult_Event_<ContainerAllocator> *;
  using ConstRawPtr =
    const nav2_msgs::action::ComputePathThroughPoses_GetResult_Event_<ContainerAllocator> *;
  using SharedPtr =
    std::shared_ptr<nav2_msgs::action::ComputePathThroughPoses_GetResult_Event_<ContainerAllocator>>;
  using ConstSharedPtr =
    std::shared_ptr<nav2_msgs::action::ComputePathThroughPoses_GetResult_Event_<ContainerAllocator> const>;

  template<typename Deleter = std::default_delete<
      nav2_msgs::action::ComputePathThroughPoses_GetResult_Event_<ContainerAllocator>>>
  using UniquePtrWithDeleter =
    std::unique_ptr<nav2_msgs::action::ComputePathThroughPoses_GetResult_Event_<ContainerAllocator>, Deleter>;
  ...
  template<typename Deleter = std::default_delete<
      nav2_msgs::action::ComputePathThroughPoses_GetResult_Event_<ContainerAllocator>>>
  using ConstUniquePtrWithDeleter =
    std::unique_ptr<nav2_msgs::action::ComputePathThroughPoses_GetResult_Event_<ContainerAllocator> const, Deleter>;
  using ConstUniquePtr = ConstUniquePtrWithDeleter<>;

  using WeakPtr =
    std::weak_ptr<nav2_msgs::action::ComputePathThroughPoses_GetResult_Event_<ContainerAllocator>>;
  using ConstWeakPtr =
    std::weak_ptr<nav2_msgs::action::ComputePathThroughPoses_GetResult_Event_<ContainerAllocator> const>;

  // pointer types similar to ROS 1, use SharedPtr / ConstSharedPtr instead
  // NOTE: Can't use 'using' here because GNU C++ can't parse attributes properly
  typedef DEPRECATED__nav2_msgs__action__ComputePathThroughPoses_GetResult_Event
    std::shared_ptr<nav2_msgs::action::ComputePathThroughPoses_GetResult_Event_<ContainerAllocator>>
    Ptr;
  typedef DEPRECATED__nav2_msgs__action__ComputePathThroughPoses_GetResult_Event
    std::shared_ptr<nav2_msgs::action::ComputePathThroughPoses_GetResult_Event_<ContainerAllocator> const>
  ...
  // comparison operators
  bool operator==(const ComputePathThroughPoses_GetResult_Event_ & other) const
  {
    if (this->info != other.info) {
      return false;
    }
...
// alias to use template instance with default allocator
using ComputePathThroughPoses_GetResult_Event =
  nav2_msgs::action::ComputePathThroughPoses_GetResult_Event_<std::allocator<void>>;
...
struct ComputePathThroughPoses_GetResult
{
  ...
  using Event = nav2_msgs::action::ComputePathThroughPoses_GetResult_Event;
};
