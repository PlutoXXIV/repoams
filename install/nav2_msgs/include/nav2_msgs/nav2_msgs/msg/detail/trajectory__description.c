  ...
  const rosidl_message_type_support_t * type_support)
{
  ...
  static rosidl_type_hash_t hash = {1, {
      0x74, 0x11, 0x90, 0x48, 0x7d, 0x20, 0x26, 0x98,
      0x37, 0xcf, 0x04, 0x09, 0xb7, 0x91, 0x7d, 0x92,
      0xfb, 0x08, 0xe2, 0x0a, 0x9e, 0x4f, 0x3e, 0x53,
      0x44, 0xd5, 0xa9, 0x7a, 0xfc, 0xcb, 0x10, 0x8c,
    }};
  return &hash;
}
...
static const rosidl_type_hash_t nav2_msgs__msg__TrajectoryPoint__EXPECTED_HASH = {1, {
    0x17, 0xcf, 0x29, 0x93, 0xd5, 0x96, 0x25, 0x0c,
    0x84, 0xb5, 0x99, 0xac, 0xff, 0x0a, 0x8d, 0xd1,
    0xee, 0x21, 0xf7, 0x76, 0xac, 0x9f, 0xee, 0x46,
    0xd9, 0x98, 0xb7, 0xac, 0xb4, 0xb0, 0x56, 0x73,
  }};
...
static char nav2_msgs__msg__Trajectory__TYPE_NAME[] = "nav2_msgs/msg/Trajectory";
...
static char nav2_msgs__msg__TrajectoryPoint__TYPE_NAME[] = "nav2_msgs/msg/TrajectoryPoint";
static char std_msgs__msg__Header__TYPE_NAME[] = "std_msgs/msg/Header";

// Define type names, field names, and default values
static char nav2_msgs__msg__Trajectory__FIELD_NAME__header[] = "header";
static char nav2_msgs__msg__Trajectory__FIELD_NAME__points[] = "points";

static rosidl_runtime_c__type_description__Field nav2_msgs__msg__Trajectory__FIELDS[] = {
  {
    {nav2_msgs__msg__Trajectory__FIELD_NAME__header, 6, 6},
    {
  ...
  {
    {nav2_msgs__msg__Trajectory__FIELD_NAME__points, 6, 6},
    {
      rosidl_runtime_c__type_description__FieldType__FIELD_TYPE_NESTED_TYPE_UNBOUNDED_SEQUENCE,
      0,
      0,
      {nav2_msgs__msg__TrajectoryPoint__TYPE_NAME, 29, 29},
    },
    {NULL, 0, 0},
  },
};

static rosidl_runtime_c__type_description__IndividualTypeDescription nav2_msgs__msg__Trajectory__REFERENCED_TYPE_DESCRIPTIONS[] = {
  {
  ...
  const rosidl_message_type_support_t * type_support)
{
  ...
  static const rosidl_runtime_c__type_description__TypeDescription description = {
    {
      {nav2_msgs__msg__Trajectory__TYPE_NAME, 24, 24},
      {nav2_msgs__msg__Trajectory__FIELDS, 2, 2},
    },
    {nav2_msgs__msg__Trajectory__REFERENCED_TYPE_DESCRIPTIONS, 11, 11},
  };
  if (!constructed) {
    ...
    assert(0 == memcmp(&nav2_msgs__msg__TrajectoryPoint__EXPECTED_HASH, nav2_msgs__msg__TrajectoryPoint__get_type_hash(NULL), sizeof(rosidl_type_hash_t)));
    description.referenced_type_descriptions.data[9].fields = nav2_msgs__msg__TrajectoryPoint__get_type_description(NULL)->type_description.fields;
...
nav2_msgs__msg__Trajectory__get_individual_type_description_source(
  const rosidl_message_type_support_t * type_support)
{
  (void)type_support;
  ...
  const rosidl_message_type_support_t * type_support)
{
  ...
  static bool constructed = false;
  if (!constructed) {
    sources[0] = *nav2_msgs__msg__Trajectory__get_individual_type_description_source(NULL),
    ...
    sources[10] = *nav2_msgs__msg__TrajectoryPoint__get_individual_type_description_source(NULL);
