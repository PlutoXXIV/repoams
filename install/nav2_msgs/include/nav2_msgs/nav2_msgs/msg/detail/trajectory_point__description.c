...
static char nav2_msgs__msg__TrajectoryPoint__FIELD_NAME__time_from_start[] = "time_from_start";
static char nav2_msgs__msg__TrajectoryPoint__FIELD_NAME__pose[] = "pose";
static char nav2_msgs__msg__TrajectoryPoint__FIELD_NAME__velocity[] = "velocity";
static char nav2_msgs__msg__TrajectoryPoint__FIELD_NAME__acceleration[] = "acceleration";
static char nav2_msgs__msg__TrajectoryPoint__FIELD_NAME__effort[] = "effort";

static rosidl_runtime_c__type_description__Field nav2_msgs__msg__TrajectoryPoint__FIELDS[] = {
  {
    {nav2_msgs__msg__TrajectoryPoint__FIELD_NAME__time_from_start, 15, 15},
    {
  ...
  {
    {nav2_msgs__msg__TrajectoryPoint__FIELD_NAME__pose, 4, 4},
    {
      rosidl_runtime_c__type_description__FieldType__FIELD_TYPE_NESTED_TYPE,
      0,
      0,
  ...
  {
    {nav2_msgs__msg__TrajectoryPoint__FIELD_NAME__velocity, 8, 8},
    {
      rosidl_runtime_c__type_description__FieldType__FIELD_TYPE_NESTED_TYPE,
      0,
      0,
  ...
  {
    {nav2_msgs__msg__TrajectoryPoint__FIELD_NAME__acceleration, 12, 12},
    {
      rosidl_runtime_c__type_description__FieldType__FIELD_TYPE_NESTED_TYPE,
      0,
      0,
  ...
  {
    {nav2_msgs__msg__TrajectoryPoint__FIELD_NAME__effort, 6, 6},
    {
      rosidl_runtime_c__type_description__FieldType__FIELD_TYPE_NESTED_TYPE,
      0,
      0,
...
static rosidl_runtime_c__type_description__IndividualTypeDescription nav2_msgs__msg__TrajectoryPoint__REFERENCED_TYPE_DESCRIPTIONS[] = {
  {
    {builtin_interfaces__msg__Duration__TYPE_NAME, 31, 31},
    {NULL, 0, 0},
  },
  ...
  static const rosidl_runtime_c__type_description__TypeDescription description = {
    {
      ...
      {nav2_msgs__msg__TrajectoryPoint__FIELDS, 5, 5},
    },
    {nav2_msgs__msg__TrajectoryPoint__REFERENCED_TYPE_DESCRIPTIONS, 8, 8},
  };
  if (!constructed) {
...
nav2_msgs__msg__TrajectoryPoint__get_individual_type_description_source(
  const rosidl_message_type_support_t * type_support)
{
  (void)type_support;
  static const rosidl_runtime_c__type_description__TypeSource source = {
    {nav2_msgs__msg__TrajectoryPoint__TYPE_NAME, 29, 29},
    {msg_encoding, 3, 3},
    {toplevel_type_raw_source, 438, 438},
  };
  return &source;
}
  ...
  const rosidl_message_type_support_t * type_support)
{
  ...
  static bool constructed = false;
  if (!constructed) {
    sources[0] = *nav2_msgs__msg__TrajectoryPoint__get_individual_type_description_source(NULL),
