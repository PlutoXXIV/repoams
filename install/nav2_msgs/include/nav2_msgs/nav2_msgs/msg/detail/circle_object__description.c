...
static char nav2_msgs__msg__CircleObject__FIELD_NAME__header[] = "header";
static char nav2_msgs__msg__CircleObject__FIELD_NAME__uuid[] = "uuid";
static char nav2_msgs__msg__CircleObject__FIELD_NAME__center[] = "center";
static char nav2_msgs__msg__CircleObject__FIELD_NAME__radius[] = "radius";
static char nav2_msgs__msg__CircleObject__FIELD_NAME__fill[] = "fill";
static char nav2_msgs__msg__CircleObject__FIELD_NAME__value[] = "value";

static rosidl_runtime_c__type_description__Field nav2_msgs__msg__CircleObject__FIELDS[] = {
  {
    {nav2_msgs__msg__CircleObject__FIELD_NAME__header, 6, 6},
    {
  ...
  {
    {nav2_msgs__msg__CircleObject__FIELD_NAME__uuid, 4, 4},
    {
      rosidl_runtime_c__type_description__FieldType__FIELD_TYPE_NESTED_TYPE,
      0,
      0,
  ...
  {
    {nav2_msgs__msg__CircleObject__FIELD_NAME__center, 6, 6},
    {
      rosidl_runtime_c__type_description__FieldType__FIELD_TYPE_NESTED_TYPE,
      0,
      0,
  ...
  {
    {nav2_msgs__msg__CircleObject__FIELD_NAME__radius, 6, 6},
    {
  ...
  {
    {nav2_msgs__msg__CircleObject__FIELD_NAME__fill, 4, 4},
    {
  ...
  {
    {nav2_msgs__msg__CircleObject__FIELD_NAME__value, 5, 5},
    {
...
static rosidl_runtime_c__type_description__IndividualTypeDescription nav2_msgs__msg__CircleObject__REFERENCED_TYPE_DESCRIPTIONS[] = {
  {
  ...
  static const rosidl_runtime_c__type_description__TypeDescription description = {
    {
      ...
      {nav2_msgs__msg__CircleObject__FIELDS, 6, 6},
    },
    {nav2_msgs__msg__CircleObject__REFERENCED_TYPE_DESCRIPTIONS, 4, 4},
  };
  if (!constructed) {
...
nav2_msgs__msg__CircleObject__get_individual_type_description_source(
  const rosidl_message_type_support_t * type_support)
{
  (void)type_support;
  ...
  const rosidl_message_type_support_t * type_support)
{
  ...
  static bool constructed = false;
  if (!constructed) {
    sources[0] = *nav2_msgs__msg__CircleObject__get_individual_type_description_source(NULL),
