  ...
  std::ostream & out)
{
  ...
  {
    out << "goals: ";
    to_flow_style_yaml(msg.goals, out);
    out << ", ";
  }
  ...
  std::ostream & out, size_t indentation = 0)
{
  // member: goals
  {
    ...
    out << "goals:\n";
    to_block_style_yaml(msg.goals, out, indentation + 2);
  }
  ...
  std::ostream & out)
{
  ...
  {
    out << "last_reached_index: ";
    rosidl_generator_traits::value_to_yaml(msg.last_reached_index, out);
    out << ", ";
  }
