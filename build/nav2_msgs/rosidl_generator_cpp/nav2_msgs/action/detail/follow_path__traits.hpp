  ...
  std::ostream & out)
{
  ...
  {
    out << "progress_checker_id: ";
    rosidl_generator_traits::value_to_yaml(msg.progress_checker_id, out);
  }
  out << "}";
...
#include "nav2_msgs/msg/detail/tracking_feedback__traits.hpp"
  ...
  std::ostream & out)
{
  ...
  // member: tracking_feedback
  {
    out << "tracking_feedback: ";
    to_flow_style_yaml(msg.tracking_feedback, out);
  }
  out << "}";
}  // NOLINT(readability/fn_size)
  ...
  std::ostream & out, size_t indentation = 0)
{
  // member: tracking_feedback
  {
    ...
    out << "tracking_feedback:\n";
    to_block_style_yaml(msg.tracking_feedback, out, indentation + 2);
  }
}  // NOLINT(readability/fn_size)
...
struct has_fixed_size<nav2_msgs::action::FollowPath_Feedback>
  : std::integral_constant<bool, has_fixed_size<nav2_msgs::msg::TrackingFeedback>::value> {};

template<>
struct has_bounded_size<nav2_msgs::action::FollowPath_Feedback>
  : std::integral_constant<bool, has_bounded_size<nav2_msgs::msg::TrackingFeedback>::value> {};
...
[[deprecated("use nav2_msgs::action::to_block_style_yaml() instead")]]
inline void to_yaml(
  const nav2_msgs::action::FollowPath_SendGoal_Event & msg,
  std::ostream & out, size_t indentation = 0)
{
  nav2_msgs::action::to_block_style_yaml(msg, out, indentation);
}
...
[[deprecated("use nav2_msgs::action::to_yaml() instead")]]
inline std::string to_yaml(const nav2_msgs::action::FollowPath_SendGoal_Event & msg)
{
  return nav2_msgs::action::to_yaml(msg);
}

template<>
inline const char * data_type<nav2_msgs::action::FollowPath_SendGoal_Event>()
{
  return "nav2_msgs::action::FollowPath_SendGoal_Event";
}

template<>
inline const char * name<nav2_msgs::action::FollowPath_SendGoal_Event>()
{
  return "nav2_msgs/action/FollowPath_SendGoal_Event";
}

template<>
struct has_fixed_size<nav2_msgs::action::FollowPath_SendGoal_Event>
  : std::integral_constant<bool, false> {};

template<>
struct has_bounded_size<nav2_msgs::action::FollowPath_SendGoal_Event>
  : std::integral_constant<bool, has_bounded_size<nav2_msgs::action::FollowPath_SendGoal_Request>::value && has_bounded_size<nav2_msgs::action::FollowPath_SendGoal_Response>::value && has_bounded_size<service_msgs::msg::ServiceEventInfo>::value> {};

template<>
struct is_message<nav2_msgs::action::FollowPath_SendGoal_Event>
  : std::true_type {};
...
[[deprecated("use nav2_msgs::action::to_block_style_yaml() instead")]]
inline void to_yaml(
  const nav2_msgs::action::FollowPath_GetResult_Event & msg,
  std::ostream & out, size_t indentation = 0)
{
  nav2_msgs::action::to_block_style_yaml(msg, out, indentation);
}
...
[[deprecated("use nav2_msgs::action::to_yaml() instead")]]
inline std::string to_yaml(const nav2_msgs::action::FollowPath_GetResult_Event & msg)
{
  return nav2_msgs::action::to_yaml(msg);
}

template<>
inline const char * data_type<nav2_msgs::action::FollowPath_GetResult_Event>()
{
  return "nav2_msgs::action::FollowPath_GetResult_Event";
}

template<>
inline const char * name<nav2_msgs::action::FollowPath_GetResult_Event>()
{
  return "nav2_msgs/action/FollowPath_GetResult_Event";
}

template<>
struct has_fixed_size<nav2_msgs::action::FollowPath_GetResult_Event>
  : std::integral_constant<bool, false> {};

template<>
struct has_bounded_size<nav2_msgs::action::FollowPath_GetResult_Event>
  : std::integral_constant<bool, has_bounded_size<nav2_msgs::action::FollowPath_GetResult_Request>::value && has_bounded_size<nav2_msgs::action::FollowPath_GetResult_Response>::value && has_bounded_size<service_msgs::msg::ServiceEventInfo>::value> {};

template<>
struct is_message<nav2_msgs::action::FollowPath_GetResult_Event>
  : std::true_type {};
