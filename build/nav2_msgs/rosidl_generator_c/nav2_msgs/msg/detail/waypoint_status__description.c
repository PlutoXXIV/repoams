...
static char nav2_msgs__msg__WaypointStatus__FIELD_NAME__waypoint_status[] = "waypoint_status";
static char nav2_msgs__msg__WaypointStatus__FIELD_NAME__waypoint_index[] = "waypoint_index";
static char nav2_msgs__msg__WaypointStatus__FIELD_NAME__waypoint_pose[] = "waypoint_pose";
static char nav2_msgs__msg__WaypointStatus__FIELD_NAME__error_code[] = "error_code";
static char nav2_msgs__msg__WaypointStatus__FIELD_NAME__error_msg[] = "error_msg";

static rosidl_runtime_c__type_description__Field nav2_msgs__msg__WaypointStatus__FIELDS[] = {
  {
    {nav2_msgs__msg__WaypointStatus__FIELD_NAME__waypoint_status, 15, 15},
    {
  ...
  {
    {nav2_msgs__msg__WaypointStatus__FIELD_NAME__waypoint_index, 14, 14},
    {
  ...
  {
    {nav2_msgs__msg__WaypointStatus__FIELD_NAME__waypoint_pose, 13, 13},
    {
  ...
  {
    {nav2_msgs__msg__WaypointStatus__FIELD_NAME__error_code, 10, 10},
    {
  ...
  {
    {nav2_msgs__msg__WaypointStatus__FIELD_NAME__error_msg, 9, 9},
    {
...
static rosidl_runtime_c__type_description__IndividualTypeDescription nav2_msgs__msg__WaypointStatus__REFERENCED_TYPE_DESCRIPTIONS[] = {
  {
  ...
  static const rosidl_runtime_c__type_description__TypeDescription description = {
    {
      ...
      {nav2_msgs__msg__WaypointStatus__FIELDS, 5, 5},
    },
    {nav2_msgs__msg__WaypointStatus__REFERENCED_TYPE_DESCRIPTIONS, 6, 6},
  };
  if (!constructed) {
...
static char toplevel_type_raw_source[] =
  ...
  "uint8 PENDING=0 # Waypoint is not processed or processing\n"
  "uint8 COMPLETED=1 # Waypoint is completed\n"
  "uint8 SKIPPED=2 # Waypoint is skipped\n"
  "uint8 FAILED=3 # Waypoint is failed\n"
...
nav2_msgs__msg__WaypointStatus__get_individual_type_description_source(
  const rosidl_message_type_support_t * type_support)
{
  (void)type_support;
  ...
  const rosidl_message_type_support_t * type_support)
{
  ...
  static bool constructed = false;
  if (!constructed) {
    sources[0] = *nav2_msgs__msg__WaypointStatus__get_individual_type_description_source(NULL),
