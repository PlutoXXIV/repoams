...
class Metaclass_ComputePathThroughPoses_Result(type):
    ...
    def __prepare__(cls, name, bases, **kwargs):
        ...
        # as well as populate each message instance
        return {
            'ALL_GOALS': cls.__constants['ALL_GOALS'],
    ...
    @property
    def LAST_REACHED_INDEX__DEFAULT(cls):
...
class ComputePathThroughPoses_Result(metaclass=Metaclass_ComputePathThroughPoses_Result):
    ...
    def __init__(self, **kwargs):
        ...
        self.last_reached_index = kwargs.get(
            'last_reached_index', ComputePathThroughPoses_Result.LAST_REACHED_INDEX__DEFAULT)
        from builtin_interfaces.msg import Duration
