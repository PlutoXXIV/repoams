...
bool nav_msgs__msg__goals__convert_from_py(PyObject * _pymsg, void * _ros_message);
ROSIDL_GENERATOR_C_IMPORT
PyObject * nav_msgs__msg__goals__convert_to_py(void * raw_ros_message);
ROSIDL_GENERATOR_C_IMPORT
...
bool nav2_msgs__action__compute_path_through_poses__goal__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  ...
  {  // goals
    ...
    if (!nav_msgs__msg__goals__convert_from_py(field, &ros_message->goals)) {
      Py_DECREF(field);
      return false;
    }
    Py_DECREF(field);
...
PyObject * nav2_msgs__action__compute_path_through_poses__goal__convert_to_py(void * raw_ros_message)
{
  ...
  {  // goals
    PyObject * field = NULL;
    field = nav_msgs__msg__goals__convert_to_py(&ros_message->goals);
    if (!field) {
      return NULL;
    }
    {
...
bool nav2_msgs__action__compute_path_through_poses__result__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  ...
  {  // last_reached_index
    PyObject * field = PyObject_GetAttrString(_pymsg, "last_reached_index");
    if (!field) {
      return false;
    }
    assert(PyLong_Check(field));
    ros_message->last_reached_index = (int16_t)PyLong_AsLong(field);
    Py_DECREF(field);
  }
  {  // planning_time
...
PyObject * nav2_msgs__action__compute_path_through_poses__result__convert_to_py(void * raw_ros_message)
{
  ...
  {  // last_reached_index
    PyObject * field = NULL;
    field = PyLong_FromLong(ros_message->last_reached_index);
    {
      int rc = PyObject_SetAttrString(_pymessage, "last_reached_index", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
...
ROSIDL_GENERATOR_C_EXPORT
bool nav2_msgs__action__compute_path_through_poses__send_goal__event__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("nav2_msgs.action._compute_path_through_poses.ComputePathThroughPoses_SendGoal_Event", full_classname_dest, 83) == 0);
  }
  nav2_msgs__action__ComputePathThroughPoses_SendGoal_Event * ros_message = _ros_message;
  {  // info
  ...
  {  // request
    ...
    if (!nav2_msgs__action__ComputePathThroughPoses_SendGoal_Request__Sequence__init(&(ros_message->request), size)) {
      PyErr_SetString(PyExc_RuntimeError, "unable to create nav2_msgs__action__ComputePathThroughPoses_SendGoal_Request__Sequence ros_message");
      Py_DECREF(seq_field);
      Py_DECREF(field);
      return false;
    }
    nav2_msgs__action__ComputePathThroughPoses_SendGoal_Request * dest = ros_message->request.data;
    for (Py_ssize_t i = 0; i < size; ++i) {
      if (!nav2_msgs__action__compute_path_through_poses__send_goal__request__convert_from_py(PySequence_Fast_GET_ITEM(seq_field, i), &dest[i])) {
        Py_DECREF(seq_field);
        Py_DECREF(field);
        return false;
      }
  ...
  {  // response
    ...
    if (!nav2_msgs__action__ComputePathThroughPoses_SendGoal_Response__Sequence__init(&(ros_message->response), size)) {
      PyErr_SetString(PyExc_RuntimeError, "unable to create nav2_msgs__action__ComputePathThroughPoses_SendGoal_Response__Sequence ros_message");
      Py_DECREF(seq_field);
      Py_DECREF(field);
      return false;
    }
    nav2_msgs__action__ComputePathThroughPoses_SendGoal_Response * dest = ros_message->response.data;
    for (Py_ssize_t i = 0; i < size; ++i) {
      if (!nav2_msgs__action__compute_path_through_poses__send_goal__response__convert_from_py(PySequence_Fast_GET_ITEM(seq_field, i), &dest[i])) {
        Py_DECREF(seq_field);
        Py_DECREF(field);
        return false;
      }
...
ROSIDL_GENERATOR_C_EXPORT
PyObject * nav2_msgs__action__compute_path_through_poses__send_goal__event__convert_to_py(void * raw_ros_message)
{
  /* NOTE(esteve): Call constructor of ComputePathThroughPoses_SendGoal_Event */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("nav2_msgs.action._compute_path_through_poses");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "ComputePathThroughPoses_SendGoal_Event");
    assert(pymessage_class);
    Py_DECREF(pymessage_module);
    _pymessage = PyObject_CallObject(pymessage_class, NULL);
    Py_DECREF(pymessage_class);
  ...
  nav2_msgs__action__ComputePathThroughPoses_SendGoal_Event * ros_message = (nav2_msgs__action__ComputePathThroughPoses_SendGoal_Event *)raw_ros_message;
  {  // info
    PyObject * field = NULL;
  ...
  {  // request
    ...
    for (size_t i = 0; i < size; ++i) {
      ...
      PyObject * pyitem = nav2_msgs__action__compute_path_through_poses__send_goal__request__convert_to_py(item);
      if (!pyitem) {
        Py_DECREF(field);
        return NULL;
      }
  ...
  {  // response
    ...
    for (size_t i = 0; i < size; ++i) {
      ...
      PyObject * pyitem = nav2_msgs__action__compute_path_through_poses__send_goal__response__convert_to_py(item);
      if (!pyitem) {
        Py_DECREF(field);
        return NULL;
      }
...
ROSIDL_GENERATOR_C_EXPORT
bool nav2_msgs__action__compute_path_through_poses__get_result__event__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("nav2_msgs.action._compute_path_through_poses.ComputePathThroughPoses_GetResult_Event", full_classname_dest, 84) == 0);
  }
  nav2_msgs__action__ComputePathThroughPoses_GetResult_Event * ros_message = _ros_message;
  {  // info
    PyObject * field = PyObject_GetAttrString(_pymsg, "info");
    if (!field) {
      return false;
  ...
  {  // request
    ...
    if (!nav2_msgs__action__ComputePathThroughPoses_GetResult_Request__Sequence__init(&(ros_message->request), size)) {
      PyErr_SetString(PyExc_RuntimeError, "unable to create nav2_msgs__action__ComputePathThroughPoses_GetResult_Request__Sequence ros_message");
      Py_DECREF(seq_field);
      Py_DECREF(field);
      return false;
    }
    nav2_msgs__action__ComputePathThroughPoses_GetResult_Request * dest = ros_message->request.data;
    for (Py_ssize_t i = 0; i < size; ++i) {
      if (!nav2_msgs__action__compute_path_through_poses__get_result__request__convert_from_py(PySequence_Fast_GET_ITEM(seq_field, i), &dest[i])) {
        Py_DECREF(seq_field);
        Py_DECREF(field);
        return false;
      }
  ...
  {  // response
    ...
    if (!nav2_msgs__action__ComputePathThroughPoses_GetResult_Response__Sequence__init(&(ros_message->response), size)) {
      PyErr_SetString(PyExc_RuntimeError, "unable to create nav2_msgs__action__ComputePathThroughPoses_GetResult_Response__Sequence ros_message");
      Py_DECREF(seq_field);
      Py_DECREF(field);
      return false;
    }
    nav2_msgs__action__ComputePathThroughPoses_GetResult_Response * dest = ros_message->response.data;
    for (Py_ssize_t i = 0; i < size; ++i) {
      if (!nav2_msgs__action__compute_path_through_poses__get_result__response__convert_from_py(PySequence_Fast_GET_ITEM(seq_field, i), &dest[i])) {
        Py_DECREF(seq_field);
        Py_DECREF(field);
        return false;
      }
...
ROSIDL_GENERATOR_C_EXPORT
PyObject * nav2_msgs__action__compute_path_through_poses__get_result__event__convert_to_py(void * raw_ros_message)
{
  /* NOTE(esteve): Call constructor of ComputePathThroughPoses_GetResult_Event */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("nav2_msgs.action._compute_path_through_poses");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "ComputePathThroughPoses_GetResult_Event");
    assert(pymessage_class);
    Py_DECREF(pymessage_module);
    _pymessage = PyObject_CallObject(pymessage_class, NULL);
    Py_DECREF(pymessage_class);
  ...
  nav2_msgs__action__ComputePathThroughPoses_GetResult_Event * ros_message = (nav2_msgs__action__ComputePathThroughPoses_GetResult_Event *)raw_ros_message;
  {  // info
    PyObject * field = NULL;
    field = service_msgs__msg__service_event_info__convert_to_py(&ros_message->info);
    if (!field) {
  ...
  {  // request
    ...
    for (size_t i = 0; i < size; ++i) {
      item = &(ros_message->request.data[i]);
      PyObject * pyitem = nav2_msgs__action__compute_path_through_poses__get_result__request__convert_to_py(item);
      if (!pyitem) {
        Py_DECREF(field);
        return NULL;
      }
  ...
  {  // response
    ...
    for (size_t i = 0; i < size; ++i) {
      item = &(ros_message->response.data[i]);
      PyObject * pyitem = nav2_msgs__action__compute_path_through_poses__get_result__response__convert_to_py(item);
      if (!pyitem) {
        Py_DECREF(field);
        return NULL;
      }
