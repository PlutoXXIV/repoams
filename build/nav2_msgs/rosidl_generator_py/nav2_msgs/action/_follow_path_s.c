...
bool nav2_msgs__action__follow_path__goal__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  ...
  {  // progress_checker_id
    PyObject * field = PyObject_GetAttrString(_pymsg, "progress_checker_id");
    if (!field) {
      return false;
    }
    assert(PyUnicode_Check(field));
    ...
    rosidl_runtime_c__String__assign(&ros_message->progress_checker_id, PyBytes_AS_STRING(encoded_field));
    Py_DECREF(encoded_field);
    Py_DECREF(field);
  }
...
PyObject * nav2_msgs__action__follow_path__goal__convert_to_py(void * raw_ros_message)
{
  ...
  {  // progress_checker_id
    PyObject * field = NULL;
    field = PyUnicode_DecodeUTF8(
      ros_message->progress_checker_id.data,
      strlen(ros_message->progress_checker_id.data),
      "replace");
    if (!field) {
      return NULL;
    }
    {
      int rc = PyObject_SetAttrString(_pymessage, "progress_checker_id", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
...
bool nav2_msgs__action__follow_path__feedback__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  ...
  {  // tracking_feedback
    PyObject * field = PyObject_GetAttrString(_pymsg, "tracking_feedback");
    if (!field) {
      return false;
    }
    if (!nav2_msgs__msg__tracking_feedback__convert_from_py(field, &ros_message->tracking_feedback)) {
      Py_DECREF(field);
      return false;
    }
    Py_DECREF(field);
...
PyObject * nav2_msgs__action__follow_path__feedback__convert_to_py(void * raw_ros_message)
{
  ...
  {  // tracking_feedback
    PyObject * field = NULL;
    field = nav2_msgs__msg__tracking_feedback__convert_to_py(&ros_message->tracking_feedback);
    if (!field) {
      return NULL;
    }
    {
      int rc = PyObject_SetAttrString(_pymessage, "tracking_feedback", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
...
ROSIDL_GENERATOR_C_EXPORT
bool nav2_msgs__action__follow_path__send_goal__event__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("nav2_msgs.action._follow_path.FollowPath_SendGoal_Event", full_classname_dest, 55) == 0);
  }
  nav2_msgs__action__FollowPath_SendGoal_Event * ros_message = _ros_message;
  {  // info
  ...
  {  // request
    ...
    if (!nav2_msgs__action__FollowPath_SendGoal_Request__Sequence__init(&(ros_message->request), size)) {
      PyErr_SetString(PyExc_RuntimeError, "unable to create nav2_msgs__action__FollowPath_SendGoal_Request__Sequence ros_message");
      Py_DECREF(seq_field);
      Py_DECREF(field);
      return false;
    }
    nav2_msgs__action__FollowPath_SendGoal_Request * dest = ros_message->request.data;
    for (Py_ssize_t i = 0; i < size; ++i) {
      if (!nav2_msgs__action__follow_path__send_goal__request__convert_from_py(PySequence_Fast_GET_ITEM(seq_field, i), &dest[i])) {
        Py_DECREF(seq_field);
        Py_DECREF(field);
        return false;
      }
  ...
  {  // response
    ...
    if (!nav2_msgs__action__FollowPath_SendGoal_Response__Sequence__init(&(ros_message->response), size)) {
      PyErr_SetString(PyExc_RuntimeError, "unable to create nav2_msgs__action__FollowPath_SendGoal_Response__Sequence ros_message");
      Py_DECREF(seq_field);
      Py_DECREF(field);
      return false;
    }
    nav2_msgs__action__FollowPath_SendGoal_Response * dest = ros_message->response.data;
    for (Py_ssize_t i = 0; i < size; ++i) {
      if (!nav2_msgs__action__follow_path__send_goal__response__convert_from_py(PySequence_Fast_GET_ITEM(seq_field, i), &dest[i])) {
        Py_DECREF(seq_field);
        Py_DECREF(field);
        return false;
      }
...
ROSIDL_GENERATOR_C_EXPORT
PyObject * nav2_msgs__action__follow_path__send_goal__event__convert_to_py(void * raw_ros_message)
{
  ...
  nav2_msgs__action__FollowPath_SendGoal_Event * ros_message = (nav2_msgs__action__FollowPath_SendGoal_Event *)raw_ros_message;
  {  // info
    PyObject * field = NULL;
  ...
  {  // request
    ...
    for (size_t i = 0; i < size; ++i) {
      ...
      PyObject * pyitem = nav2_msgs__action__follow_path__send_goal__request__convert_to_py(item);
      if (!pyitem) {
        Py_DECREF(field);
        return NULL;
      }
  ...
  {  // response
    ...
    for (size_t i = 0; i < size; ++i) {
      ...
      PyObject * pyitem = nav2_msgs__action__follow_path__send_goal__response__convert_to_py(item);
      if (!pyitem) {
        Py_DECREF(field);
        return NULL;
      }
...
ROSIDL_GENERATOR_C_EXPORT
bool nav2_msgs__action__follow_path__get_result__event__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("nav2_msgs.action._follow_path.FollowPath_GetResult_Event", full_classname_dest, 56) == 0);
  }
  nav2_msgs__action__FollowPath_GetResult_Event * ros_message = _ros_message;
  {  // info
    PyObject * field = PyObject_GetAttrString(_pymsg, "info");
    if (!field) {
      return false;
  ...
  {  // request
    ...
    if (!nav2_msgs__action__FollowPath_GetResult_Request__Sequence__init(&(ros_message->request), size)) {
      PyErr_SetString(PyExc_RuntimeError, "unable to create nav2_msgs__action__FollowPath_GetResult_Request__Sequence ros_message");
      Py_DECREF(seq_field);
      Py_DECREF(field);
      return false;
    }
    nav2_msgs__action__FollowPath_GetResult_Request * dest = ros_message->request.data;
    for (Py_ssize_t i = 0; i < size; ++i) {
      if (!nav2_msgs__action__follow_path__get_result__request__convert_from_py(PySequence_Fast_GET_ITEM(seq_field, i), &dest[i])) {
        Py_DECREF(seq_field);
        Py_DECREF(field);
        return false;
      }
  ...
  {  // response
    ...
    if (!nav2_msgs__action__FollowPath_GetResult_Response__Sequence__init(&(ros_message->response), size)) {
      PyErr_SetString(PyExc_RuntimeError, "unable to create nav2_msgs__action__FollowPath_GetResult_Response__Sequence ros_message");
      Py_DECREF(seq_field);
      Py_DECREF(field);
      return false;
    }
    nav2_msgs__action__FollowPath_GetResult_Response * dest = ros_message->response.data;
    for (Py_ssize_t i = 0; i < size; ++i) {
      if (!nav2_msgs__action__follow_path__get_result__response__convert_from_py(PySequence_Fast_GET_ITEM(seq_field, i), &dest[i])) {
        Py_DECREF(seq_field);
        Py_DECREF(field);
        return false;
      }
...
ROSIDL_GENERATOR_C_EXPORT
PyObject * nav2_msgs__action__follow_path__get_result__event__convert_to_py(void * raw_ros_message)
{
  ...
  nav2_msgs__action__FollowPath_GetResult_Event * ros_message = (nav2_msgs__action__FollowPath_GetResult_Event *)raw_ros_message;
  {  // info
    PyObject * field = NULL;
    field = service_msgs__msg__service_event_info__convert_to_py(&ros_message->info);
    if (!field) {
  ...
  {  // request
    ...
    for (size_t i = 0; i < size; ++i) {
      item = &(ros_message->request.data[i]);
      PyObject * pyitem = nav2_msgs__action__follow_path__get_result__request__convert_to_py(item);
      if (!pyitem) {
        Py_DECREF(field);
        return NULL;
      }
  ...
  {  // response
    ...
    for (size_t i = 0; i < size; ++i) {
      item = &(ros_message->response.data[i]);
      PyObject * pyitem = nav2_msgs__action__follow_path__get_result__response__convert_to_py(item);
      if (!pyitem) {
        Py_DECREF(field);
        return NULL;
      }
