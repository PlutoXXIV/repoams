...
#include "nav2_msgs/msg/detail/tracking_feedback__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const nav2_msgs::msg::TrackingFeedback & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  nav2_msgs::msg::TrackingFeedback & ros_message)
{
  // Member: header
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = nav2_msgs::msg::TrackingFeedback;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const nav2_msgs::msg::TrackingFeedback *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<nav2_msgs::msg::TrackingFeedback *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _TrackingFeedback__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const nav2_msgs::msg::TrackingFeedback *>(
...
static size_t _TrackingFeedback__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_TrackingFeedback(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _TrackingFeedback__callbacks = {
  "nav2_msgs::msg",
  "TrackingFeedback",
...
static rosidl_message_type_support_t _TrackingFeedback__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_TrackingFeedback__callbacks,
...
{
  return &nav2_msgs::msg::typesupport_fastrtps_cpp::_TrackingFeedback__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, nav2_msgs, msg, TrackingFeedback)() {
  return &nav2_msgs::msg::typesupport_fastrtps_cpp::_TrackingFeedback__handle;
}
